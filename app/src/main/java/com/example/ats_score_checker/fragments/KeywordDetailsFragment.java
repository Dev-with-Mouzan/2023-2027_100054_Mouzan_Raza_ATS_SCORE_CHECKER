...
import com.example.ats_score_checker.databinding.FragmentKeywordDetailsBinding;

public class KeywordDetailsFragment extends Fragment {
    private FragmentKeywordDetailsBinding binding;

    @Nullable 
    @Override 
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentKeywordDetailsBinding.inflate(inflater, container, false);
