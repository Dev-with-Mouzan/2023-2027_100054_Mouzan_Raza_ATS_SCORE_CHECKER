...
import com.example.ats_score_checker.databinding.FragmentResumeEditorBinding;

public class ResumeEditorFragment extends Fragment {
    private FragmentResumeEditorBinding binding;

    @Nullable 
    @Override 
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentResumeEditorBinding.inflate(inflater, container, false);
