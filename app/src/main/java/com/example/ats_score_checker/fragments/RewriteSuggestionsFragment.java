...
import com.example.ats_score_checker.databinding.FragmentRewriteSuggestionsBinding;

public class RewriteSuggestionsFragment extends Fragment {
    private FragmentRewriteSuggestionsBinding binding;

    @Nullable 
    @Override 
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentRewriteSuggestionsBinding.inflate(inflater, container, false);
